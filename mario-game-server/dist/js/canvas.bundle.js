...
canvas.width = 1024;
canvas.height = 576;
var gravity = 1.5; // Player Creation
...
var Player = /*#__PURE__*/function () {
  function Player() {
    ...
    this.sprites = {
      stand: {
        ...
        cropWidth: 177,
        // width of the image 10620 px / 60 ( the number of frames in the image)
        width: 66
      },
      run: {
        ...
        cropWidth: 341,
        width: 127.875 // to get the correct dimensions showing

      }
    };
    this.currentSprite = this.sprites.stand.right;
    this.currentCropWidth = 177; // width of the image 10620 px / 60 ( the number of frames in the image)
  }
  ...
  _createClass(Player, [{
    ...
    value: function draw() {
      ...
      c.drawImage(this.currentSprite, this.currentCropWidth * this.frames, // to make the character animate and pop up and down
      0, this.currentCropWidth, // width of the image 10620 px / 60 ( the number of frames in the image)
    ...
    value: function update() {
      ...
      if (this.position.y + this.height + this.velocity.y <= canvas.height) this.velocity.y += gravity; // else this.velocity.y = 0;        ==> removed to make the player disappears from the screen when falling
    }
  }]);
...
// getting the KeyboardEvent properties
